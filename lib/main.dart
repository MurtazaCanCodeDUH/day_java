...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      ...
      await _controller1
          .loadUrl('https://reeborg.ca/reeborg.html?lang=en&mode=javascript');
      ...
      await _controller2.loadUrl('https://reeborg.ca/reeborg.html?lang=en&mode=javascript');
      ...
      await _controller0.loadUrl('https://reeborg.ca/reeborg.html?lang=en&mode=javascript');
